        ...
        <div class="wrapper row-offcanvas row-offcanvas-left">
            ...
            <aside class="right-side">
                ...
                <section class="content-header">
                    <h1>
                        Graduations faculty/supervisor
                                    ...
                                    <div class="box-group" id="accordion">
                                        ...
                                        <div class="panel box box-primary">
                                            ...
                                            <div id="collapseOne" class="panel-collapse collapse in">
                                                <div class="box-body">                                                
													Which is the total number of degreed students per faculty and per supervisor? 
													<br> 
                                        ...
                                        <div class="panel box box-warning">
                                            ...
                                            <div id="collapseTwo" class="panel-collapse collapse" style="height: 0px;">
                                                <div class="box-body">
<b>CREATE MATERIALIZED VIEW</b> admt2014_unibzdw.degreed_faculty_supervisor <b>AS</b>	<br><b>SELECT</b> sd.status, sd.student_key, cd.faculty, pf.surname	<br><b>FROM</b> admt2014_unibzdw.degree_fact df, admt2014_unibzdw.student_dimension sd, admt2014_unibzdw.supervisor_dimension sv, admt2014_unibzdw.curriculum_dimension cd, admt2014_unibzdw.professor_dimension pf, admt2014_unibzdw.date_dimension dd	<br><b>WHERE</b> df.student_key = sd.student_key <b>AND</b> df.date_key = dd.date_key <b>AND</b> sd.curriculum_key = cd.curriculum_key <b>AND</b> df.supervisor_key = sv.supervisor_key <b>AND</b> sv.supervisor_key = pf.professor_key	<br><b>GROUP BY</b> sd.student_key, cd.faculty, pf.professor_key, sd.status	<br><b>ORDER BY</b> cd.faculty, pf.professor_key;                
	</div></div></div>
                                        ...
                                        <div class="panel box box-danger">
                                            <div class="box-header">
                                             ...
                                             <div id="collapseThree" class="panel-collapse collapse" style="height: 0px;">
                                                <div class="box-body">
<b>SELECT</b> sd.student_key, sd.faculty, sd.surname<br><b>FROM</b> admt2014_unibzdw.degreed_faculty_supervisor sd<br><b>WHERE</b> sd.status='Degreed'<br><b>GROUP BY</b> sd.student_key, sd.faculty, sd.surname<br><b>ORDER BY</b> sd.faculty;                
</div></div></div>
                                    ...
                                    <table id="rollup" class="table table-bordered table-hover dataTable" aria-describedby="example2_info">
                                        ...
                                        %>
                                        	...
                                        	<tr class="odd">
                                                ...
                                                <td class=" "><%out.print(i_ships.get(i).getName_one()); %></td>
