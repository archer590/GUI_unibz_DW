            ...
            <aside class="right-side">
                ...
                <section class="content-header">
                    ...
                    <ol class="breadcrumb">
                        ...
                        <li >Queries</li>
                        <li class="active">Outgoing students</li>
                    </ol>
                </section>
                                    ...
                                    <div class="box-group" id="accordion">
                                        ...
                                        <div class="panel box box-primary">
                                            ...
                                            <div id="collapseOne" class="panel-collapse collapse in">
                                                <div class="box-body">                                                
													How many outgoing students are there per curriculum per study plan per faculty? 
													<br> 
                ...
                <div class="box box-success">
                                ...
                                <div class="box-body">
                                    <table id="rollup" class="table table-bordered table-hover dataTable" aria-describedby="example2_info">
                                        ...
                                        <%
                                        	Vector<InOutcoming_Student> outgoing_students = dbConn.rollup_outgoing_students();                                        
                                                                                for(int i=0; i<outgoing_students.size();i++)
                                                                                	{
                                        %>
                                        	
                                        	<tr class="odd">
                                                <td class=" sorting_1"><%out.print(outgoing_students.get(i).getFaculty()); %></td>
                                                <td class=" "><%out.print(outgoing_students.get(i).getStudy_plan()); %></td>
                                                <td class=" "><%out.print(outgoing_students.get(i).getCurriculum_name()); %></td>
                                                <td class=" "><%out.print(outgoing_students.get(i).getCount()); %></td>                                                
                                        	</tr>
                                        	<%
                                        	}                                        	
                                        	%></tbody></table>
